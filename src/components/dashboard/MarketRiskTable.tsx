    ...
    <Card className="h-full">
      <CardHeader className="p-3 pt-5">
        <div className="flex flex-wrap gap-2">
          <button className="px-3 py-1 rounded bg-blue-100 text-blue-700 text-xs">
            Euribor1w
          </button>
          <button className="px-3 py-1 rounded text-gray-500 text-xs">
            Euribor2w
          </button>
          <button className="px-3 py-1 rounded text-gray-500 text-xs">
            Euribor3w
            ...
            <TableBody>
              {data.map((row) => (
                <TableRow key={row.tenor}>
                  <TableCell className="text-xs py-4">{row.tenor}</TableCell>
                  <TableCell className="text-xs py-2">
                    {row.marketPlaceRate}
                  </TableCell>
                  <TableCell className="text-xs py-2">
                    {row.marketRiskFreeRate}
                  </TableCell>
                  <TableCell className="text-xs py-2">
                    {row.marketRiskFreeSpread}
                  </TableCell>
