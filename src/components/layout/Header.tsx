    ...
    <header className="pt-1 pb-4 px-6 flex items-center bg-white relative">
      <div className="flex items-center mr-auto pl-12">
        ...
        <nav className="flex items-center">
          <Link
            href="/pret"
            className="text-gray-700 hover:text-blue-700 transition-colors mr-8"
          >
            Prêt
          </Link>
          <Link
      ...
      <div className="hidden md:flex items-center pr-16">
        ...
        <Button
          variant="outline"
          className="border-green-500 text-green-500 hover:bg-green-50 mr-4"
        >
          S&apos;inscrire
        </Button>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="absolute top-16 left-0 right-0 bg-white p-6 shadow-lg md:hidden z-50">
